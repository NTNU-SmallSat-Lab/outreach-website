...
const ClientOnlyComponent: React.FC<ClientOnlyComponentProps> = ({ fetchSatelliteData }) => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      const data =  mapTleToSatData( mapRawDataToTleData(await fetchSatelliteData({ useExampleData: true })));
